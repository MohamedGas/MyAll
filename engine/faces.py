...
faces = {}
for face in (os.listdir("C:/Users/CoderCamps/Envs/python-app-with-electron-gui-master/gui/faces")):
    if not face.startswith("."):
        with open("C:/Users/CoderCamps/Envs/python-app-with-electron-gui-master/gui/faces/" + face, 'rb') as fp:
            face_info = c.load(fp)
            faces[face] = {}
